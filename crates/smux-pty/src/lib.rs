//! smux -- async PTY lifecycle management for Rust
//!
//! smux wraps POSIX `forkpty`/`openpty` with an async-first tokio API,
...
//!
//! ```rust,no_run
//! use smux::{PtyConfig, oneshot};
//!
//! #[tokio::main]
//! async fn main() -> smux::Result<()> {
//!     let config = PtyConfig::new("/bin/echo").args(["hello, smux!"]);
