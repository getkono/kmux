...
fn snapshot_to_ansi(
    ...
    scrollback_lines: &[Vec<kmux_protocol::messages::CellState>],
) -> Vec<u8> {
    let mut out = Vec::new();
...
fn emit_cells_line(out: &mut Vec<u8>, cells: &[kmux_protocol::messages::CellState]) {
    use kmux_protocol::messages::CellAttrs;
